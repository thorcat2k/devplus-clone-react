       ...
       <div className="footer-row">
         <div className="footer-cover">
          ...
          <div className="footer-cover">
           ...
           <ul className="footer-text">
             <li>
               <a href="https://www.facebook.com/Devplusprogramme " className="footer-link" target="_blank " > Training space </a>
             </li>
             <li>
               <a href="https://www.facebook.com/Devplusprogramme " className="footer-link" target="_blank ">Alumni network</a>
             </li>
             <li>
               <a href="https://conext.asia/" className="footer-link" target="_blank ">Connect with experts </a>
             </li>
           </ul>
         </div>
         <div className="footer-cover">
           ...
           <ul className="footer-text">
             <li>
               <a href='# ' className="footer-link">One plus (+) Programing foundation</a>
             </li>
             <li>
               <a href="# " className="footer-link"> Two plus (++) Skill up and onboard</a>
             </li>
             <li>
               <a href="# " className="footer-link">Three plus (+++) Become a senior</a>
             </li>
           </ul>
         </div>
             ...
             <ul className="footer-fb">
               <li className="facebook-footer">
                <a href="https://www.facebook.com/Devplusprogramme " target="_blank ">
                  <BsFacebook className="fa fa-facebook" aria-hidden="true"></BsFacebook>
                  </a>
               </li>
